...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $singleRoleUsers = [
            ...
            ['username' => 'staf 1', 'nama_lengkap' => 'Dirli', 'email' => 'dirli@banksulteng.co.id', 'jabatan' => 'Staf Unit Kerja Umum & RT', 'bagian' => 'Bagian Umum & Rumah Tangga', 'role_id' => 13, 'department_id' => null],
            ['username' => 'staf 2', 'nama_lengkap' => 'Marsya', 'email' => 'umum@banksulteng.co.id', 'jabatan' => 'Staf Pengelolaan Dokumen & Kearsipan', 'bagian' => 'Bagian Umum & Rumah Tangga', 'role_id' => 14, 'department_id' => null],
        ];
