...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            ['username' => 'agil', 'nama_lengkap' => 'Pak Agil', 'jabatan' => 'Staf Umum & RT', 'bagian' => 'Umum & Rumah Tangga', 'role_id' => 3],
            ['username' => 'irma', 'nama_lengkap' => 'Kaka Irma', 'jabatan' => 'Staf Aset & Logistik', 'bagian' => 'Aset/Inventaris & Logistik', 'role_id' => 4],
            ['username' => 'dwi', 'nama_lengkap' => 'Kaka Dwi', 'jabatan' => 'Staf Aset & Logistik', 'bagian' => 'Aset/Inventaris & Logistik', 'role_id' => 4],
