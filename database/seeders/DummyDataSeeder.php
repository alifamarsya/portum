...
class DummyDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pksList = [
            ...
            ['no_pks' => 'PKS/102/BS/X/2024', 'judul' => 'Jasa Layanan Kebersihan (Cleaning Service) Terpadu', 'vendor' => 'PT ISS Indonesia', 'div_owner' => 'Divisi Umum', 'tanggal_mulai' => '2024-10-01', 'jatuh_tempo' => now()->addDays(230)->toDateString(), 'nilai' => 360000000, 'status' => 'Aktif', 'approval_status' => 'Disetujui'],
